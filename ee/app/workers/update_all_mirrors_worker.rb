...
class UpdateAllMirrorsWorker
  ...
  def schedule_projects_in_batch(projects)
    contexts_for_arguments = {}
    projects.each do |project|
      contexts_for_arguments[[project.id]] = { project: project }
    end

    ProjectImportScheduleWorker.bulk_perform_async_with_contexts(contexts_for_arguments)
  end
end
